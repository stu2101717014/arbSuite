...
public class ApisView extends HorizontalLayout {
    ...
    private final Grid<PlatformDataRequestWrapperEntityDAO> grid = new Grid<>(PlatformDataRequestWrapperEntityDAO.class, false);
    ...
    private PlatformDataRequestWrapperEntityDAO selected;
    ...
    public ApisView(@Autowired ApisService apisService) {
        ...
        List<PlatformDataRequestWrapperEntityDAO> all = apisService.getAll();
        configureGrid(all);
    ...
    private void buttonSaveClicked(ClickEvent<Button> e) {
        PlatformDataRequestWrapperEntityDAO newEnt = new PlatformDataRequestWrapperEntityDAO();
    ...
    private void configureGrid(List<PlatformDataRequestWrapperEntityDAO> all) {
        grid.addClassNames("apis-grid");
        grid.addThemeVariants(GridVariant.LUMO_WRAP_CELL_CONTENT);

        grid.addColumn(PlatformDataRequestWrapperEntityDAO::getPlatformName).setHeader("Platform Name");
        grid.addColumn(PlatformDataRequestWrapperEntityDAO::getUrl).setHeader("URL");
        grid.addColumn(PlatformDataRequestWrapperEntityDAO::getAccessible).setHeader("Accessible");
    ...
    private void onGridSelect(SelectionEvent<Grid<PlatformDataRequestWrapperEntityDAO>, PlatformDataRequestWrapperEntityDAO> event) {
